  ...
  <div class="row">
    ...
    <div class="col-md-3 mb-3 mt-3">
      <div class="card" style="box-shadow: -1px 1px 10px 1px rgba(0,0,0,0.5); animation-delay: 5s;">
          <img src="berita/<?php echo($perberita['gambar']); ?>" class="card-img-top" alt="..." style="height: 250px; display: flex;">
          <div class="overlay overlayPopup">
            <div class="text">
              <b><p><?php echo date("d F Y", strtotime($perberita ['tanggal'])) ?></p></b>
              <b><p><?php echo($perberita['judul']); ?></p></b>
              <a href="berita_selengkapnya.php?id=<?php echo($perberita['id_berita']); ?>" class="btn btn-sm btn-outline-light" style="border-radius: 18px;">&nbsp;&nbsp;Selengkapnya&nbsp;&nbsp;</a>
            </div>
          </div>
      </div>
    </div>
