          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <a href="tambah_penduduk.php" class="btn btn-sm btn-success"><i class="fa fa-plus" title="Tambah Penduduk"></i>&nbsp;Tambah Data</a>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <a href="edit_penduduk.php?id=<?php echo $pecah ['id_penduduk']; ?>" class="btn btn-sm btn-primary"><i class="fas fa-edit" title="Edit"></i></a>
                        <a href="hapus_penduduk.php?id=<?php echo $pecah ['id_penduduk']; ?>" class="btn btn-sm btn-danger"><i class="fas fa-trash-alt" title="Hapus"></i></a>
                        </div>
                      </td>
