  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>SK Pindah Penduduk</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="index.php">Home</a></li>
              <li class="breadcrumb-item active">SK Pindah Penduduk</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
            ...
            <div class="card">
              ...
              <div class="card-body">
                <?php 
                 ...
                 <form method="post" enctype="multipart/form-data" action="cetak_sk_pindah.php?id=<?php echo $pecah ['id_penduduk']; ?>">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="pendidikan_terakhir" value="<?php echo $pecah ['pendidikan_terakhir']; ?>" readonly>
                  </div>
                  <div class="form-group">
                    <label>Alamat Asal</label>
                    <input type="text" class="form-control" name="kelurahan" value="" placeholder="Kelurahan">
                    <input type="text" class="form-control" name="kecamatan" value="" placeholder="Kecamatan">
                    <input type="text" class="form-control" name="kabupaten_kota" value="" placeholder="Kabupaten/Kota">
                    <input type="text" class="form-control" name="provinsi" value="" placeholder="Provinsi">
                  </div>
                  <div class="form-group">
                    <label>Alamat Pindah</label>
                    <input type="text" class="form-control" name="kelurahanP" value="" placeholder="Kelurahan">
                    <input type="text" class="form-control" name="kecamatanP" value="" placeholder="Kecamatan">
                    <input type="text" class="form-control" name="kabupaten_kotaP" value="" placeholder="Kabupaten/Kota">
                    <input type="text" class="form-control" name="provinsiP" value="" placeholder="Provinsi">
                  </div>
                  <div class="form-group">
                    <label>Alasan Pindah</label>
                    <input type="text" class="form-control" name="alasan_pindah" value="">
                  </div>
                  ...
                  <!-- <div class="control-group after-add-more">
                              ...
                              <label>Jenis Kelamin</label>
                              <input type="text" name="jkP[]" class="form-control">
                              <label>Umur</label>
                              <input type="number" name="umurP[]" class="form-control">
                              <label>Pekerjaan</label>
                              <input type="text" name="pekerjaanP[]" class="form-control">
                              <label>Status Kawin</label>
                              <input type="text" name="statusP[]" class="form-control">
                              <br>
                              <button class="btn btn-sm btn-success add-more" type="button">Tambah Pengikut
                              </button>
                              <hr>
                  </div>-->
...
<!--                   <div class="copy hide">
                      <div class="control-group">
                              ...
                              <input type="text" name="statusP[]" class="form-control">
                              <br>
                              <button class="btn btn-sm btn-danger remove" type="button">Hapus Pengikut</button>
                              <hr>
                      </div>
                  </div> -->
