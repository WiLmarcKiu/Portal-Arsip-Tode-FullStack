  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Data SK Domisili</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="index.php">Home</a></li>
              <li class="breadcrumb-item active">Data SK Domisili</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-hover">
                  ...
                  <tbody>
                    <?php $nomor = 1; ?>
                    <?php $ambil=$koneksi->query("SELECT * FROM sk_domisili");?>
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <a href="hapus_sk_domisili.php?id=<?php echo $pecah ['id_surat']; ?>" class="btn btn-sm btn-danger"><i class="fas fa-trash-alt" title="Hapus"></i></a>
                        </div>
                      </td>
                      ...
                      <td><?php echo $pecah ['alamat_ktp_kk']; ?></td>
                      <td><?php echo $pecah ['alamat_domisili']; ?></td>
                      <td><?php echo $pecah ['nama_penanggung_jawab']; ?></td>
