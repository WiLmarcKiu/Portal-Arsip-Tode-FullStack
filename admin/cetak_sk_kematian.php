...
include '../koneksi.php';
 ?>
 				<?php 
                  ...
                  {
                    $koneksi->query ("INSERT INTO sk_kematian
                    (no_surat,tanggal_surat,nama_masyarakat,tempat_lahir,tanggal_lahir,jk,pekerjaan,agama,alamat,alamat_meninggal,tanggal_meninggal,penyebab_meninggal,nama,nip,jabatan) VALUES ('$_POST[no_surat]','$_POST[tanggal_surat]','$_POST[nama_masyarakat]','$_POST[tempat_lahir]','$_POST[tanggal_lahir]','$_POST[jk]','$_POST[pekerjaan]','$_POST[agama]','$_POST[alamat]','$_POST[alamat_meninggal]','$_POST[tanggal_meninggal]','$_POST[penyebab_meninggal]','$_POST[nama]','$_POST[nip]','$_POST[jabatan]')");
	...
	<center>
		...
		<table>
			<tr>
				<td width="500">
					<center>
						<font size="4"><b><u>SURAT KETERANGAN KEMATIAN</u></b></font>
					</center>
				</td>
			</tr>
			<tr>
		...
		<table>
			<td width="599">
				<font size="2"><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Adalah benar warga <?php echo $_POST['alamat']; ?>, dan telah meninggal dunia di <?php echo $_POST['alamat_meninggal']; ?> pada tanggal <?php echo date("d F Y", strtotime($_POST ['tanggal_meninggal'])) ?>, karena <?php echo $_POST['penyebab_meninggal']; ?>.<br><br></font>
			</td>
		</table>
		<table>
			<td width="599">
