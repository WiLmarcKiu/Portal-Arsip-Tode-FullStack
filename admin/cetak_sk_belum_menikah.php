...
include '../koneksi.php';
 ?>
 				<?php 
                  ...
                  {
                    $koneksi->query ("INSERT INTO sk_belum_menikah
                    (no_surat,tanggal_surat,nik,no_kk,nama_masyarakat,jk,suku,tempat_lahir,tanggal_lahir,kategori_usia,agama,pendidikan,pekerjaan,kewarganegaraan,alamat,tujuan_surat,nama,nip,jabatan) VALUES ('$_POST[no_surat]','$_POST[tanggal_surat]','$_POST[nik]','$_POST[no_kk]','$_POST[nama_masyarakat]','$_POST[jk]','$_POST[suku]','$_POST[tempat_lahir]','$_POST[tanggal_lahir]','$_POST[kategori_usia]','$_POST[agama]','$_POST[pendidikan]','$_POST[pekerjaan]','$_POST[kewarganegaraan]','$_POST[alamat]','$_POST[tujuan_surat]','$_POST[nama]','$_POST[nip]','$_POST[jabatan]')");
...
<html>
<head>
	<title>Cetak SK Belum Menikah</title>
	<style>
		table tr td {
			font-size: 13px;
		}
...
<body>
	...
	<center>
		...
		<table>
			<td width="599">
				<font size="2"><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Benar - benar yang bersangkutan adalah warga Kelurahan Tode Kisar, Kecamatan  Kota Lama yang berdomisili pada alamat tersebut diatas dan hingga saat surat keterangan ini dikeluarkan, yang bersangkutan <b>Belum Pernah Menikah</b>.<br><br></font>
			</td>
		</table>
		<table>
			<td width="599">
