        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">SK Kematian</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
            ...
            <div class="card">
              ...
              <div class="card-body">
                <?php 
                 ...
                 <form method="post" enctype="multipart/form-data" action="cetak_sk_kematian.php?id=<?php echo $pecah ['id_penduduk']; ?>">
                  ...
                  <div class="form-group">
                    <label>Alamat</label>
                    <textarea type="text" class="form-control" name="alamat_meninggal" rows="3" value=""></textarea>
                  </div>
                  <div class="form-group">
                    <label>Tanggal</label>
                    <input type="date" class="form-control" name="tanggal_meninggal" value="">
                  </div>
                  <div class="form-group">
                    <label>Penyebab meninggal</label>
                    <input type="text" class="form-control" name="penyebab_meninggal" value="">
                  </div>
                  <div class="alert alert-primary">
