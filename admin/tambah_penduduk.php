              ...
              <div class="card-body">
                ...
                <?php 
                  if (isset($_POST['save']))
                  {
                    ...
                    (no_kk,nik,nama,jenis_kelamin,suku,tempat_lahir,tanggal_lahir,kategori_usia,agama,pendidikan_terakhir,pekerjaan,kewarganegaraan,alamat) VALUES ('$_POST[no_kk]','$_POST[nik]','$_POST[nama]','$_POST[jk]','$_POST[suku]','$_POST[tempat_lahir]','$_POST[tanggal_lahir]','$_POST[kategori_usia]','$_POST[agama]','$_POST[pendidikan]','$_POST[pekerjaan]','$_POST[kewarganegaraan]','$_POST[alamat]')");
