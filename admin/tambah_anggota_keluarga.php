          ...
          <div class="col-12">
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <?php 
                  $ambil= $koneksi->query("SELECT * FROM penduduk");
                 ...
                 <form method="post" enctype="multipart/form-data">
                  <div class="row">
                    <div class="col-md-3">
                      <label>No. KK / Nama Kepala Keluarga :</label>
                    </div>
                    <div class="form-group col-md-3">
                    <input type="text" readonly class="form-control" value="<?php echo $pecah ['no_kk']; ?>">
                  </div>
                  <div class="form-group col-md-3">
                    <input type="text" readonly class="form-control" value="<?php echo $pecah ['nama']; ?>">
                  </div>
                  </div>
                ...
                <?php 
                  if (isset($_POST['save']))
                  {
                    ...
                    (nik,nama,jenis_kelamin,suku,tempat_lahir,tanggal_lahir,kategori_usia,agama,pendidikan_terakhir,pekerjaan,kewarganegaraan,alamat,status_dikeluarga) VALUES ('$_POST[nama]','$_POST[nik]','$_POST[jk]','$_POST[suku]','$_POST[tempat_lahir]','$_POST[tanggal_lahir]','$_POST[kategori_usia]','$_POST[agama]','$_POST[pendidikan]','$_POST[pekerjaan]','$_POST[kewarganegaraan]','$_POST[alamat]','$_POST[status]')");
