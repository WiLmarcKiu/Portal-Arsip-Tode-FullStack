                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <a href="edit_anggota_keluarga.php?id=<?php echo $pecah ['id_penduduk']; ?>" class="btn btn-sm btn-primary"><i class="fas fa-edit" title="edit"></i></a>
                        <a href="hapus_anggota_keluarga.php?id=<?php echo $pecah ['id_penduduk']; ?>" class="btn btn-sm btn-danger"><i class="fas fa-trash-alt" title="hapus"></i></a>
                        </div>
                      </td>
                      <td><?php echo $pecah ['nik']; ?></td>
                      <td><?php echo $pecah ['nama']; ?></td>
                      <td><?php echo $pecah ['alamat']; ?></td>
                      <td><?php echo $pecah ['status_dikeluarga']; ?></td>
                    </tr>
                    <?php $nomor++; ?>
                    <?php } ?>
                  </tbody>
