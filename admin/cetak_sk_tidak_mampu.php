...
include '../koneksi.php';
 ?>
 				<?php 
                  ...
                  {
                    $koneksi->query ("INSERT INTO sk_tidak_mampu
                    (no_surat,tanggal_surat,nama_masyarakat,tempat_lahir,tanggal_lahir,jk,pekerjaan,agama,nik,no_kk,alamat,tujuan_surat,nama,nip,jabatan) VALUES ('$_POST[no_surat]','$_POST[tanggal_surat]','$_POST[nama_masyarakat]','$_POST[tempat_lahir]','$_POST[tanggal_lahir]','$_POST[jk]','$_POST[pekerjaan]','$_POST[agama]','$_POST[nik]','$_POST[no_kk]','$_POST[alamat]','$_POST[tujuan_surat]','$_POST[nama]','$_POST[nip]','$_POST[jabatan]')");
...
<html>
<head>
	<title>Cetak SK Tidak Mampu</title>
	<style>
		table tr td {
			font-size: 13px;
		}
	...
	<center>
		...
		<table>
			<tr>
				<td width="500">
					<center>
						<font size="4"><b><u>SURAT KETERANGAN TIDAK MAMPU</u></b></font>
					</center>
				</td>
			</tr>
			<tr>
		...
		<table>
			<td width="599">
				<font size="2"><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Benar adalah warga Kelurahan Tode Kisar Kecamatan Kota Lama - Kota Kupang, yang berdomisili pada alamat tersebut diatas dan sesuai data yang bersangkutan berasal dari keluarga tidak mampu. Surat keterangan ini sebagai Rekomendasi <?php echo $_POST['tujuan_surat']; ?>.<br><br></font>
			</td>
		</table>
		<table>
			<td width="599">
