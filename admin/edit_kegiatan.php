              ...
              <div class="card-body">
                ...
                // jika foto dirubah
                    if(!empty($lokasifoto))
                    {
                      ...
                      $koneksi->query("UPDATE kegiatan SET judul = '$_POST[judul]',isi = '$_POST[isi]',tanggal = '$_POST[tanggal]',gambar = '$namafoto' WHERE id_kegiatan = '$_GET[id]'");
                    }
                    else
                    {
                      move_uploaded_file($lokasifoto, "../kegiatan/$namafoto");
                      $koneksi->query("UPDATE kegiatan SET judul = '$_POST[judul]',isi = '$_POST[isi]',tanggal = '$_POST[tanggal]' WHERE id_kegiatan = '$_GET[id]'");
                    }
