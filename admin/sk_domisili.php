        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">SK Domisili</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
            ...
            <div class="card">
              ...
              <div class="card-body">
                <?php 
                 ...
                 <form method="post" enctype="multipart/form-data" action="cetak_sk_domisili.php?id=<?php echo $pecah ['id_penduduk']; ?>">
                  ...
                  <div class="form-group">
                    <label>Alamat sesuai KTP / KK</label>
                    <textarea type="text" class="form-control" name="alamat_ktp_kk" rows="3" value=""></textarea>
                  </div>
                  <div class="form-group">
                    <label>Alamat Domisili saat ini</label>
                    <textarea type="text" class="form-control" name="alamat_domisili" rows="3" value=""></textarea>
                  </div>
                  <div class="alert alert-primary">
                    <p>Yang menjadi penangggung jawab :</p>
                  </div>
                  <div class="form-group">
                    <label>Nama</label>
                    <input type="text" class="form-control" name="nama_penanggung_jawab" value="">
                  </div>
                  <div class="form-group">
                    <label>NIK</label>
                    <input type="number" class="form-control" name="nik_penanggung_jawab" value="">
                  </div>
                  <div class="form-group">
                    <label>No. KK</label>
                    <input type="number" class="form-control" name="no_kk_penanggung_jawab" value="">
                  </div>
                  <div class="form-group">
