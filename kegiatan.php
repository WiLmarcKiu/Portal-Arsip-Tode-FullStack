...
<div class="container animated fadeInLeft">
  <div class="row">
    ...
    <?php while ($perkegiatan = $ambil->fetch_assoc()) { ?>

    <div class="col-md-4 mb-3 mt-3">
      <div class="card" style="box-shadow: -1px 1px 10px 1px rgba(0,0,0,0.5); animation-delay: 5s;">
          <img src="kegiatan/<?php echo($perkegiatan['gambar']); ?>" class="card-img-top" alt="..." style="height: 250px; display: flex;">
          <div class="overlay overlayPopup">
            <div class="text">
              <b><p><?php echo date("d F Y", strtotime($perkegiatan ['tanggal'])) ?></p></b>
              <b><p><?php echo($perkegiatan['judul']); ?></p></b>
              <a href="kegiatan_selengkapnya.php?id=<?php echo($perkegiatan['id_kegiatan']); ?>" class="btn btn-sm btn-outline-light" style="border-radius: 18px;">&nbsp;&nbsp;Selengkapnya&nbsp;&nbsp;</a>
            </div>
          </div>
      </div>
    </div>
